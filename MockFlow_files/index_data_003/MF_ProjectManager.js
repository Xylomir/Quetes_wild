...
p.uploadProjectLogo = function(p0, p1, p2, p3, p4, callback) {
return dwr.engine._execute(p._path, 'MF_ProjectManager', 'uploadProjectLogo', arguments);
};
...
p.updateProjectTheme = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_ProjectManager', 'updateProjectTheme', arguments);
};
...
p.removeProjectLogo = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_ProjectManager', 'removeProjectLogo', arguments);
};
...
p.generateScreenshot = function(p0, p1, p2, p3, p4, callback) {
