...
return dwr.engine._execute(p._path, 'MF_AccountManager', 'checkUser', arguments);
};
...
p.checkGoogleUser = function(p0, p1, p2, p3, p4, p5, callback) {
return dwr.engine._execute(p._path, 'MF_AccountManager', 'checkGoogleUser', arguments);
};
