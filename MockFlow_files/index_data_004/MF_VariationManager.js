...
(function() {
if (dwr.engine._getObject("MF_VariationManager") == undefined) {
var p;
...
return dwr.engine._execute(p._path, 'MF_VariationManager', 'IsExist', arguments);
};
...
p.countVariations = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_VariationManager', 'countVariations', arguments);
};
...
p.getVariationByID = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_VariationManager', 'getVariationByID', arguments);
};
...
return dwr.engine._execute(p._path, 'MF_VariationManager', 'correctStorageSize', arguments);
};
...
return dwr.engine._execute(p._path, 'MF_VariationManager', 'getStorageSize', arguments);
};
...
p.updateDescription = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_VariationManager', 'updateDescription', arguments);
};
...
p.updateVariationLabel = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_VariationManager', 'updateVariationLabel', arguments);
};
...
return dwr.engine._execute(p._path, 'MF_VariationManager', 'updateUsedSize', arguments);
};
...
return dwr.engine._execute(p._path, 'MF_VariationManager', 'getThumbnail', arguments);
};
...
p.moveVariation = function(p0, p1, p2, p3, p4, p5, p6, callback) {
return dwr.engine._execute(p._path, 'MF_VariationManager', 'moveVariation', arguments);
};
...
p.deleteVariation = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_VariationManager', 'deleteVariation', arguments);
};
...
p.deleteVariation = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'MF_VariationManager', 'deleteVariation', arguments);
};
...
p.renameVariation = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_VariationManager', 'renameVariation', arguments);
};
...
p.sortVariations = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_VariationManager', 'sortVariations', arguments);
};
...
return dwr.engine._execute(p._path, 'MF_VariationManager', 'create', arguments);
};
...
return dwr.engine._execute(p._path, 'MF_VariationManager', 'list', arguments);
};

dwr.engine._setObject("MF_VariationManager", p);
}
})();
