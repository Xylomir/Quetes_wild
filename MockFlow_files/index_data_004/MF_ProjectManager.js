...
p.approveVariation = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_ProjectManager', 'approveVariation', arguments);
};
...
p.uploadWireframe2Files = function(p0, p1, p2, p3, p4, p5, p6, p7, callback) {
return dwr.engine._execute(p._path, 'MF_ProjectManager', 'uploadWireframe2Files', arguments);
};
...
p.unApproveVariation = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_ProjectManager', 'unApproveVariation', arguments);
};
...
p.updateBoardCount = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_ProjectManager', 'updateBoardCount', arguments);
};
...
p.updateApproveCount = function(p0, p1, callback) {
return dwr.engine._execute(p._path, 'MF_ProjectManager', 'updateApproveCount', arguments);
};
