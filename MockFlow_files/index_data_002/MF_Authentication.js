...
p.getAtlassianAddOnUser = function(p0, callback) {
return dwr.engine._execute(p._path, 'MF_Authentication', 'getAtlassianAddOnUser', arguments);
};
...
p.addPublicSecureKeyHash = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_Authentication', 'addPublicSecureKeyHash', arguments);
};
