...
p.uploadWireframe2Files = function(p0, p1, p2, p3, p4, p5, p6, callback) {
...
p.updateTheme = function(p0, p1, p2, p3, callback) {
return dwr.engine._execute(p._path, 'MF_ProjectManager', 'updateTheme', arguments);
};
...
p.parseSiteMapXml = function(p0, p1, p2, callback) {
return dwr.engine._execute(p._path, 'MF_ProjectManager', 'parseSiteMapXml', arguments);
};
...
p.generateScreenshot = function(p0, p1, p2, p3, p4, p5, callback) {
